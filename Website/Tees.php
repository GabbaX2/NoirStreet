...
<?php include("nav.php"); ?>
    ...
    <div class="relative h-96 bg-black text-white overflow-hidden">
        ...
        <div class="container mx-auto h-full flex flex-col justify-center items-center px-4 relative">
            ...
            <div class="flex flex-col items-center">
                ...
                <h1 class="text-7xl md:text-8xl font-playfair font-bold tracking-tighter">TEES</h1>
            ...
            <div class="absolute bottom-16 md:bottom-12 flex flex-col items-center">
                ...
                <p class="text-lg md:text-xl font-light italic">"Elegance in simplicity."</p>
            </div>
    ...
    <!-- Messaggio di successo o errore per recensioni -->
<?php if(isset($review_success)): ?>
    <div class="alert alert-success shadow-lg max-w-lg mx-auto mt-4">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            <span><?php echo $review_success; ?></span>
        </div>
    </div>
<?php endif; ?>

<?php if(isset($review_error)): ?>
    <div class="alert alert-error shadow-lg max-w-lg mx-auto mt-4">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            <span><?php echo $review_error; ?></span>
        </div>
    </div>
<?php endif; ?>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="group">
                    ...
                    <div class="pt-4 pb-2">
                        ...
                        <!-- Visualizzazione recensioni esistenti (da implementare) -->
                        <?php
...
<!-- Script per il conteggio dei caratteri -->
<script>
    document.getElementById('comment').addEventListener('input', function() {
        ...
        // Opzionale: limita l'input se supera maxLength
