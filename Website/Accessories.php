...
// Query per ottenere i prodotti di categoria accessori
$query = "SELECT p.*, b.nome_b, s.nome_s 
          FROM prodotti p 
          JOIN brand b ON p.nome_b = b.nome_b 
          JOIN stili s ON p.nome_s = s.nome_s 
          WHERE p.nome_cat IN ('Occhiali', 'Borse', 'Calze', 'Cinture', 'Cappellini', 'Gioielli', 'Orologi')";
...
// Base query per ottenere i prodotti di categoria "Maglietta"
$query = "SELECT p.*, b.nome_b, s.nome_s 
          FROM prodotti p 
          JOIN brand b ON p.nome_b = b.nome_b 
          JOIN stili s ON p.nome_s = s.nome_s 
          WHERE p.nome_cat = 'Magliette'";
...
<head>
    <meta charset="UTF-8">
    <title>NoirStreet | Accessori</title>
...
<!-- Banner della categoria in stile Vogue -->
<div class="relative h-96 bg-black text-white overflow-hidden">
    ...
    <div class="container mx-auto h-full flex flex-col justify-center items-center px-4 relative">
        ...
        <div class="flex flex-col items-center">
            ...
            <h1 class="text-7xl md:text-8xl font-playfair font-bold tracking-tighter">ACCESSORIES</h1>
        ...
        <div class="absolute bottom-16 md:bottom-12 flex flex-col items-center">
            <p class="text-xs tracking-widest opacity-50 font-light mb-2">SPRING/SUMMER 2025</p>
            <p class="text-lg md:text-xl font-light italic">"The final touch that defines style."</p>
        </div>
...
<!-- Sezione tendenze degli accessori -->
<section class="py-16 bg-gray-950">
    <div class="container mx-auto px-8">
        <div class="flex flex-col items-center mb-12">
            <div class="w-12 h-px bg-gray-400 mb-4"></div>
            <h2 class="text-3xl md:text-4xl font-playfair font-bold text-center">Accessory Trends 2025</h2>
            <div class="w-24 h-px bg-gray-400 mt-4"></div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-black p-6 border border-gray-800">
                <div class="h-1 w-12 bg-gray-400 mb-4"></div>
                <h3 class="text-xl font-playfair mb-3">Statement Eyewear</h3>
                <p class="text-gray-400 text-sm">Bold frames and tinted lenses dominate this season's eyewear collections. Look for geometric shapes and unexpected color combinations.</p>
            </div>

            <div class="bg-black p-6 border border-gray-800">
                <div class="h-1 w-12 bg-gray-400 mb-4"></div>
                <h3 class="text-xl font-playfair mb-3">Sculptural Jewelry</h3>
                <p class="text-gray-400 text-sm">Architectural and abstract pieces that blur the line between art and accessory. This season favors statement pieces over minimal designs.</p>
            </div>

            <div class="bg-black p-6 border border-gray-800">
                <div class="h-1 w-12 bg-gray-400 mb-4"></div>
                <h3 class="text-xl font-playfair mb-3">Tech-Integrated Watches</h3>
                <p class="text-gray-400 text-sm">The fusion of luxury timepieces with subtle smart technology creates the perfect balance between classic style and modern functionality.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-400">
                    ...
                    <li><a href="Pants-Skirts.php" class="hover:text-white">Pants & Skirts</a></li>
